...
const client = new MongoClient("mongodb+srv://ziyodilladev:ziyodilla123@cluster0.t9s2ir2.mongodb.net");
...
export const addBotUser = async (name: string, balance: number,
  img: string) => {
  try {
...
export const updateBotUser = async (_id: ObjectId, name: string, img: string) => {
  try {
